         	...
         	<ul class="form">
         		<li>BU:
              	...
              	<jsp:getProperty name="chooseListBean" property="buList"/> 
						...
						<li>ID:
							<input type="text"  id="textbox" name="item_id" class="searchbox" placeholder="Search Item"  maxlength="18"  onchange="submit();" onkeydown="if (window.event && window.event.keyCode == 13){submit();}" value="<c:out value="${item_id}"/>">
						</li>
					</ul>
